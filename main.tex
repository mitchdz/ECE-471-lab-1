...
Figure~\ref{fig:c23} shows the linux command used to convert the ciphertex that was shown into the accompanying plaintext. For ease of copying, the command is also shown below.
...
0xE8 is 232 in decimal. Let's change that value to 231 (1 bit off) so byte 55 will now be 
